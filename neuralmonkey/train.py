...
def create_config() -> Configuration:
    ...
    config.add_argument("val_preview_output_series",
                        required=False, default=None)
    config.add_argument('start_temperature', required=False, default=0.0)
    config.add_argument('lowering_temp_by', required=False, default=0.7)
...
def _main() -> None:
    ...
    training_loop(
        ...
        temp=cfg.model.start_temperature,
        lowering_temp_by=cfg.model.lowering_temp_by,
